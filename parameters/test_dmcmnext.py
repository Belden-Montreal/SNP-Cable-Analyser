...
class TestDMCMNEXT(TestParameter):
    def createParameter(self):
        return DMCMNEXT(self._e2ePorts, self._freq, self._matrices)

    def testComputePairs(self):
        seDmcmnext = DMCMNEXT(self._ports, self._freq, self._matrices)
        pairs = seDmcmnext.getPairs()

        # for a 4 ports single ended, there are 6 DMCMNEXT pairs
    ...
    def testComputeParameter(self):
        ...
        # for a 4 ports, there is only 2 DMCMNEXT pairs
    ...
    def testComputeComplexParameter(self):
        ...
        # for a 4 ports, there is only 2 DMCMNEXT pairs (including reverse)
        self.assertEqual(len(parameter), 2)
