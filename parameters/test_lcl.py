...
class TestLCL(TestParameter):
    def testComputeParameter(self):
        ...
        self.assertEqual(parameter[0][0], complex2db(self._matrices[0, 0, 4]))
        self.assertEqual(parameter[0][1], complex2db(self._matrices[1, 0, 4]))
        self.assertEqual(parameter[0][2], complex2db(self._matrices[2, 0, 4]))
        self.assertEqual(parameter[0][3], complex2db(self._matrices[3, 0, 4]))

        # check the values of the port 2
        self.assertEqual(parameter[1][0], complex2db(self._matrices[0, 1, 5]))
        self.assertEqual(parameter[1][1], complex2db(self._matrices[1, 1, 5]))
        self.assertEqual(parameter[1][2], complex2db(self._matrices[2, 1, 5]))
        self.assertEqual(parameter[1][3], complex2db(self._matrices[3, 1, 5]))

        # check the values of the port 3
        self.assertEqual(parameter[2][0], complex2db(self._matrices[0, 2, 6]))
        self.assertEqual(parameter[2][1], complex2db(self._matrices[1, 2, 6]))
        self.assertEqual(parameter[2][2], complex2db(self._matrices[2, 2, 6]))
        self.assertEqual(parameter[2][3], complex2db(self._matrices[3, 2, 6]))

        # check the values of the port 4
        self.assertEqual(parameter[3][0], complex2db(self._matrices[0, 3, 7]))
        self.assertEqual(parameter[3][1], complex2db(self._matrices[1, 3, 7]))
        self.assertEqual(parameter[3][2], complex2db(self._matrices[2, 3, 7]))
        self.assertEqual(parameter[3][3], complex2db(self._matrices[3, 3, 7]))
