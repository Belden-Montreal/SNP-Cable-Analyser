...
from snpanalyzer.project.plug import Plug, PlugNode
from snpanalyzer.project.alien import Alien, AlienNode
from snpanalyzer.project.embedding import Embedding, EmbeddingNode
