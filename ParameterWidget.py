...
class ParameterWidget():
    ...
    def setPairsList(self):
        self.paramWidget.marginListWidget.addItems(self.sample.port_name.values())
        self.paramWidget.marginListWidget.sortItems()
        self.paramWidget.marginListWidget.setCurrentRow(0)
        self.paramWidget.worstListWidget.addItems(self.sample.port_name.values())
