...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(9, 9, 991, 701))
        ...
        self.alienGeneralInfo = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.victimRun = QtWidgets.QPushButton(self.alienGeneralInfo)
        self.victimRun.setObjectName("victimRun")
        self.verticalLayout_2.addWidget(self.victimRun)
        self.victimLabel = QtWidgets.QLabel(self.alienGeneralInfo)
        self.victimLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.victimLabel.setObjectName("victimLabel")
        self.verticalLayout_2.addWidget(self.victimLabel)
        ...
        self.alienPlots = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.alienDisturbersGroup = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.alienTestTypeGroup = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.alienEndGroup = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.alienRun = QtWidgets.QPushButton(self.layoutWidget)
        self.alienRun.setObjectName("alienRun")
        self.verticalLayout_8.addWidget(self.alienRun)
        self.alienImportSNP = QtWidgets.QPushButton(self.layoutWidget)
    ...
    def retranslateUi(self, Form):
        ...
        self.victimRun.setText(_translate("Form", "Acquire Victim"))
        self.victimLabel.setText(_translate("Form", "\"\""))
        ...
        self.alienRun.setText(_translate("Form", "Acquire Alien "))
