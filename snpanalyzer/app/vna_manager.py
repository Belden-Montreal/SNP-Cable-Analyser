import snpanalyzer.gui.ui.vna_addr_dialog
import snpanalyzer.gui.ui.vna_configuration
from snpanalyzer.app.communication import Communication
...
class Test_Params_Dialog:
    def getParams(self, comm):
        ...
        params_dialog = vna_configuration.Ui_form()
